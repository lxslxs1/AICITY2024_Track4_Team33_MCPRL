...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/sy/lxs/AICITY/data/rotate/train/format_rotate_train_N.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/home/sy/lxs/AICITY/data/Fisheye8k/val/format_val_N.json',
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        '/home/sy/lxs/AICITY/data/Fisheye8k/test/images_180/coco_format.json',
        img_prefix='/home/sy/lxs/AICITY/data/Fisheye8k/test/images_180',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
log_level = 'INFO'
load_from = '/home/sy/lxs/giga/Co-DETR/weights/co_dino_5scale_swin_large_16e_o365tococo.pth'
resume_from =  None
workflow = [('train', 1)]
