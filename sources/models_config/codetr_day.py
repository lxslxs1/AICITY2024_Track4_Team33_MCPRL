...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/sy/lxs/AICITY/data/rotate/train/format_rotate_train.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/home/sy/lxs/AICITY/data/Fisheye8k/val/format_val.json',
...
resume_from = '/home/sy/lxs/AICITY/Co-DETR/my_models/co_dino_5scale_swin_large_16e_o365tococo_my_fish_rotate/epoch_4.pth'
workflow = [('train', 1)]
